"""Anonymisation de PDFs et détection NER de noms d'élèves.
...
- anonymize_pdf() : anonymise le PDF avant envoi cloud (Mistral OCR).
"""
...
def anonymize_pdf(
    ...
    Utilisé avant l'envoi cloud (Mistral OCR) et par scripts/debug_parse.py.
