...
| 2026-02-19 | RGPD | Corrigé `clear_mappings()` : `RETURNING` au lieu de `rowcount` (bug DuckDB) |
...
42 tests dans `tests/test_pseudonymizer.py`, `tests/test_pseudonymize_extraction.py`, `tests/test_purge.py`.
